...
st.image(r"C:\Users\dipen\Downloads\curriculum-vitae.png") 
...
try:
    ...
    if len(predicted) > 0:
        ...
        # Create Word Cloud
              wordcloud = WordCloud(width = 3000, height = 2000, background_color='white', max_words=100,colormap='plasma').generate(all_resume_text)
